...
function ReadReceipt({ isRead, otherUserReceiptsEnabled }) {
  // Double red check = read + receipts enabled
  // Single grey check = sent (unread or receipts off)
  if (isRead && otherUserReceiptsEnabled !== false) {
    return <CheckCheck size={14} className="text-red-400 flex-shrink-0" />
  }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-1">
              ...
              {u.is_verified && <ShieldCheck size={13} className="text-red-400 fill-current [&>path:last-child]:stroke-white" />}
              {u.partner_tier === 'verified' && <ShieldCheck size={12} className="text-emerald-400 fill-current [&>path:last-child]:stroke-white" />}
              {u.partner_tier === 'red' && <ShieldCheck size={12} className="text-red-400 fill-current [&>path:last-child]:stroke-white" />}
              {u.partner_tier === 'gold' && <ShieldCheck size={12} className="text-amber-400 fill-current [&>path:last-child]:stroke-white" />}
            </div>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1">
                  ...
                  {conv.otherUser?.is_verified && <ShieldCheck size={13} className="text-red-400 fill-current [&>path:last-child]:stroke-white" />}
                  {conv.otherUser?.partner_tier === 'verified' && <ShieldCheck size={12} className="text-emerald-400 fill-current [&>path:last-child]:stroke-white" />}
                  {conv.otherUser?.partner_tier === 'red' && <ShieldCheck size={12} className="text-red-400 fill-current [&>path:last-child]:stroke-white" />}
                  {conv.otherUser?.partner_tier === 'gold' && <ShieldCheck size={12} className="text-amber-400 fill-current [&>path:last-child]:stroke-white" />}
                  ...
                  <div className="flex-1 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1">
                        ...
                        {selectedConv.otherUser.is_verified && <ShieldCheck size={13} className="text-red-400 fill-current [&>path:last-child]:stroke-white" />}
                        {selectedConv.otherUser.partner_tier === 'verified' && <ShieldCheck size={12} className="text-emerald-400 fill-current [&>path:last-child]:stroke-white" />}
                        {selectedConv.otherUser.partner_tier === 'red' && <ShieldCheck size={12} className="text-red-400 fill-current [&>path:last-child]:stroke-white" />}
                        {selectedConv.otherUser.partner_tier === 'gold' && <ShieldCheck size={12} className="text-amber-400 fill-current [&>path:last-child]:stroke-white" />}
