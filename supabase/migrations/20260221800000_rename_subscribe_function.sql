-- Fix: Rename subscribe_to_creator → process_subscription to avoid
-- PostgREST schema cache holding stale overload references.
-- This is a brand-new function name so no cache ambiguity is possible.

-- Drop every possible leftover
